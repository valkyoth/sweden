...
| Fenced cache-fill admission | optional exact-identity/access-partition `CacheFillLease` at `0.48.0` | resource/cancellation audits at `0.52.0`/`0.53.0`, recovery at `0.70.0`, topology proof at `0.91.0` |
