...
| Bounded provider-driven access rebind/relookup cycles | generic non-cloneable restart ledger at `0.3.0`, policy/manifest/registry-bound `AccessRebindLimit` at `0.7.0..=0.9.0`, executor-owned ledger consumption at `0.21.0`, Trafikverket binding at `0.23.0` | oscillation/expiry/epoch/cache-only behavior at `0.38.0`, ownership/lifecycle/security/accounting/hostile-provider audits at `0.45.0`/`0.46.0`/`0.50.0`/`0.52.0`/`0.53.0`, recovery at `0.70.0`, topology proof at `0.91.0`, freeze at `0.98.0` |
